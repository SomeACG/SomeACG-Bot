...
const twitterGot = require('./twitter-got.js');
const { graphQLMap, featuresMap } = require('./constants.js');
...
const cacheTryGet = async (cache, _id, params, func) => {
    ...
    return cache.tryGet(`twitter:${id}:${funcName}:${paramsString}`, () => func(id, params), 300, false);
};
